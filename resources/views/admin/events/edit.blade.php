                                ...
                                <div class="col-12 col-lg-3">
                                    <div class="mb-3">
                                        <label for="deadline" class="form-label text-primary-emphasis">Scadenza Iscrizioni</label>
                                             <input type="datetime-local" lang="it" class="form-control form-control-sm border border-2 border-primary weekday-date-input @error('deadline') is-invalid @enderror"
                                ...
                                <div class="col-12 col-sm-6 col-xl-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm border border-2 border-primary @error('address') is-invalid @enderror"
                                               id="address" name="address" value="{{ old('address', $event->via) }}" required maxlength="35">
                                        @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
