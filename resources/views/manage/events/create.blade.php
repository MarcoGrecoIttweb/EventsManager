...
@section('content')
    <style>
        ...
        form[action="{{ route('manage.events.store') }}"] .form-control,
        form[action="{{ route('manage.events.store') }}"] .form-select {
            height: var(--event-create-field-h);
        }
        form[action="{{ route('manage.events.store') }}"] textarea.form-control {
            height: auto;
        }
        form[action="{{ route('manage.events.store') }}"] input[type="file"].form-control {
            height: var(--event-create-field-h);
            padding-top: 0.25rem;
                            ...
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <div class="mb-3">
                                        <label for="deadline" class="form-label text-primary-emphasis">Scadenza Iscrizioni</label>
                                             <input type="datetime-local" lang="it" class="form-control border border-2 border-primary weekday-date-input @error('deadline') is-invalid @enderror"
                                ...
                                <div id="max_guests_container" class="col-6 col-lg-auto event-create-media-max {{ old('allow_guests', true) ? '' : 'd-none' }}">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-sm border border-2 border-primary @error('max_guests_per_user') is-invalid @enderror"
