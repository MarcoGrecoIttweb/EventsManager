                        ...
                        @if($isProfileOwner)
                            <form action="{{ route('profile.toggle-hide-participated-events', $user) }}" method="POST" class="m-0">
                                ...
                                @if($user->nascondi_eventi_partecipati)
                                    <button type="submit" class="btn btn-sm" style="background-color: #CC9900; border: 1px solid #dc3545; color: #000;" data-hint="Visualizza l'elenco degli eventi a cui hai partecipato anche agli altri amici">
